<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditAdminPSW.aspx.cs" Inherits="admin_audit" %>
...
<body>
    ...
    <div>
   <table>
        <tr><td align="center" colspan="2" style ="font-size:x-large">※用户管理员修改密码模块</td></tr>
        <tr><td align="center" colspan="2" style ="font-size:x-large"></td></tr> 
        <tr><td>管理员身份证：</td><td><asp:Label ID="lbUserName" runat="server" ></asp:Label></td></tr>
